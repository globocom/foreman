...
class OperatingsystemTest < ActiveSupport::TestCase
  ...
  describe "families" do
    ...
    test "families_as_collection contains correct names and values" do
      ...
      assert_equal ["AIX", "Altlinux", "Arch Linux", "CoreOS", "DNOS", "Debian", "FreeBSD", "Gentoo", "Junos", "NX-OS", "Red Hat", "SUSE", "Solaris", "Windows"], families.map(&:name).sort
      assert_equal ["AIX", "Altlinux", "Archlinux", "Coreos", "DNOS", "Debian", "Freebsd", "Gentoo", "Junos", "NXOS", "Redhat", "Solaris", "Suse", "Windows"], families.map(&:value).sort
    end
  end
